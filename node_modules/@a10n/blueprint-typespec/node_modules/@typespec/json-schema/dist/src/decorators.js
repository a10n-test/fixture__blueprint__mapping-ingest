import { isTemplateDeclaration, isType, serializeValueAsJson, setTypeSpecNamespace, typespecTypeToJson, } from "@typespec/compiler";
...
export function getJsonSchemaTypes(program) {
    ...
    function visitDeclaration(type) {
        if (!(type.kind !== "Enum" && isTemplateDeclaration(type)) &&
